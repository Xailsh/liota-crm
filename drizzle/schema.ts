...
export const instructors = mysqlTable("instructors", {
  ...
  campus: mysqlEnum("campus", ["merida", "dallas", "denver", "vienna", "online"]).notNull(),
...
export const leads = mysqlTable("leads", {
  ...
  preferredCampus: mysqlEnum("preferredCampus", ["merida", "dallas", "denver", "vienna", "online"]),
...
export const expenses = mysqlTable("expenses", {
  ...
  amount: decimal("amount", { precision: 10, scale: 2 }).notNull(),
  currency: varchar("currency", { length: 8 }).default("USD"),
  campus: mysqlEnum("campus", ["merida", "dallas", "denver", "vienna", "online", "general"]).default("general"),
...
export const campaigns = mysqlTable("campaigns", {
  ...
  segmentCampus: mysqlEnum("segmentCampus", ["merida", "dallas", "denver", "vienna", "online", "all"]).default("all"),
