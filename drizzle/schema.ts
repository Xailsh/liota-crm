...
export const users = mysqlTable("users", {
  ...
  role: mysqlEnum("role", ["user", "admin", "instructor", "coordinator", "receptionist", "sales", "marketing", "finance", "ventas"]).default("user").notNull(),
...
export const invitations = mysqlTable("invitations", {
  ...
  role: mysqlEnum("role", ["admin", "user", "instructor", "coordinator", "receptionist", "sales", "marketing", "finance", "ventas"]).notNull().default("user"),
